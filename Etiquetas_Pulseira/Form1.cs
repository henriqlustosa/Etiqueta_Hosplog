            ...
            using (Graphics g = e.Graphics)
            {
                using (Font fnt = new Font("Arial", 12))
                {
                    ...
                    if (paciente.nm_nome.Length < 16)
                    {
                        ...
                        {
                            string nomemae1 = paciente.nm_mae;
                            contN = nomemae1.Length;
                            nomep = paciente.nm_mae.Substring(0, 24);
                            nomeCompos = nomemae1.Substring(24);
                            g.DrawString("MAE: " + nomep, new Font("Arial", 8, FontStyle.Regular), System.Drawing.Brushes.Black, startXEsquerda, starty + 45);
                            g.DrawString( nomeCompos, new Font("Arial", 8, FontStyle.Regular), System.Drawing.Brushes.Black, startXEsquerda, starty + 60);
                        }
                    }
                    else 
                    {
                        string nomep1 = paciente.nm_nome;
                        contN = nomep1.Length;
                        nomep = paciente.nm_nome.Substring(0, 16);
                        nomeCompos = nomep1.Substring(16);
                        
                        g.DrawString("PRONTUARIO: " + paciente.cd_prontuario, new Font("Arial", 8, FontStyle.Regular), System.Drawing.Brushes.Black, startXEsquerda, starty );
                        g.DrawString("PACIENTE: " + nomep, new Font("Arial", 8, FontStyle.Bold), System.Drawing.Brushes.Black, startXEsquerda, starty + 15);
                        g.DrawString(nomeCompos, new Font("Arial", 8, FontStyle.Bold), System.Drawing.Brushes.Black, startXEsquerda, starty + 30);
                        g.DrawString("NASC.: " + paciente.dt_data_nascimento, new Font("Arial", 8, FontStyle.Regular), System.Drawing.Brushes.Black, startXEsquerda, starty + 45);
                        if (paciente.nm_mae.Length < 24)
                        {
                            g.DrawString("MAE: " + paciente.nm_mae, new Font("Arial", 8, FontStyle.Regular), System.Drawing.Brushes.Black, startXEsquerda, starty + 60);
                        }
                        else
                        {
                            string nomemae1 = paciente.nm_mae;
                            ...
                            nomep = paciente.nm_mae.Substring(0, 24);
                            nomeCompos = nomemae1.Substring(24);
                            g.DrawString("MAE: " + nomep, new Font("Arial", 8, FontStyle.Regular), System.Drawing.Brushes.Black, startXEsquerda, starty + 60);
                            g.DrawString(nomeCompos, new Font("Arial", 8, FontStyle.Regular), System.Drawing.Brushes.Black, startXEsquerda, starty + 75);
                        }
                    }
                }
            }
